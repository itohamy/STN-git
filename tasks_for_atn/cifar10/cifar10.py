...
tf.app.flags.DEFINE_string('data_dir', '../../../data/cifar10/cifar10_train',
...
def inference(images):
  ...
  regularizations = {"r":0,"t":0.03,"sc":0.03,"sh":0.03}
  ...
  return softmax_linear, transformations, alignment_loss, transformations_regularizer 
#  return softmax_linear, 0, 0, 0 
